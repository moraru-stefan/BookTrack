...
interface RegisterFormProps {
  onSuccess: () => void
  switchElement: ReactNode
}

export function RegisterForm({ onSuccess, switchElement }: RegisterFormProps) {
  ...
  return (
    <div>
      ...
      <p className="mt-6 text-sm text-slate-500">Hai già un account? {switchElement}</p>
    </div>
  )
}
